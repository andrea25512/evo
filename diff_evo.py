...
template = { 
    "differential_evolution": """Given some prompts, generate a better prompt:

    An example of the step-by-step process:
    ...
    Given the following prompts, generate a better prompt:
    Prompt 1: <prompt1>
    Prompt 2: <prompt2>
    Prompt 3: <prompt3>
